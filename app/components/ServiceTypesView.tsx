              ...
              <div>
                        ...
                        {editingStepIndex === i ? (
                          <>
                            <input
                              ...
                              className="flex-1 px-2 py-1 text-sm border border-[#3b82f6] rounded outline-none"
                              autoFocus
                            />
                          ...
                          <>
                            <span
                              className="flex-1 text-sm text-gray-700 cursor-pointer hover:text-[#3b82f6]"
                            ...
                            <button
                              onClick={() => startEditStep(i)}
                              className="p-0.5 text-gray-300 hover:text-[#3b82f6] opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer"
                              title="Editar passo"
                            >
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-1.5 border border-gray-200 rounded-lg text-sm outline-none focus:border-[#3b82f6] transition-colors"
                  />
                  <button
                    onClick={addStep}
              ...
              <div>
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    placeholder="Chave"
                    className="w-28 px-3 py-1.5 border border-gray-200 rounded-lg text-sm outline-none focus:border-[#3b82f6] transition-colors"
                  />
                  <button
                    onClick={addField}
