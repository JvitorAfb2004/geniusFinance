...
export default function LeadModal({ lead, onClose }: { lead?: Lead; onClose: () => void }) {
  ...
  const renderSelect = (
    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative" ref={dropdownRef}>
        <div className="flex items-center border border-gray-200 rounded-lg focus-within:ring-2 focus-within:ring-[#3b82f6]/30 focus-within:border-[#3b82f6] transition-all bg-white">
          ...
          <button
            ...
            className="px-2 py-2 text-gray-400 hover:text-[#3b82f6] transition-colors cursor-pointer"
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[10vh] px-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl border border-[#e2e8f0] w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
        {/* Header */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                className="px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-[#3b82f6] cursor-pointer"
              />
            </div>
            ...
            <div className="sm:col-span-2 flex flex-col gap-1">
              ...
              <textarea
                ...
                className="px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-[#3b82f6] resize-none h-24"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 px-6 py-4 border-t border-[#e2e8f0] bg-gray-50/50 shrink-0">
          ...
          <button
            ...
            className="px-6 py-2 bg-[#3b82f6] text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 transition-colors font-medium text-sm cursor-pointer"
          >
