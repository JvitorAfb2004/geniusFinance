        ...
        <div className="clay p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <button onClick={() => handleSubscribe('CARD')} disabled={actionLoading}
              className="p-6 border-2 border-slate-100 rounded-2xl hover:border-primary hover:shadow-[0_1px_4px_rgba(91,125,239,0.1)] transition-colors cursor-pointer text-left disabled:opacity-50">
