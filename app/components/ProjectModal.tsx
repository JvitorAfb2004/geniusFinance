          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-primary cursor-pointer bg-white"
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0,00"
                  className="w-full pl-10 pr-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-primary transition-colors"
                />
              </div>
            </div>
            <div>
          ...
          <div>
            ...
            <div className="relative" data-dropdown>
              <button
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm text-left outline-none focus:border-primary cursor-pointer bg-white flex items-center justify-between"
              >
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-3">
                <input
                  ...
                  className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm outline-none focus:border-primary transition-colors"
                />
                <select
                  value={newTaskPriority}
                  onChange={(e) => setNewTaskPriority(e.target.value as TaskPriority)}
                  className="px-2 py-2 border border-gray-200 rounded-lg text-xs outline-none focus:border-primary cursor-pointer bg-white"
                >
                          ...
                          <div className="px-3 pb-3 space-y-3 border-t border-gray-200/50 pt-3 ml-6">
                            ...
                            <div>
                              ...
                              <textarea
                                ...
                                rows={2}
                                className="w-full px-3 py-1.5 border border-gray-200 rounded-lg text-sm outline-none focus:border-primary resize-none"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <select
                                ...
                                className="px-3 py-1.5 border border-gray-200 rounded-lg text-sm outline-none focus:border-primary cursor-pointer bg-white"
                              >
                                <option value="LOW">Baixa</option>
                                <option value="MEDIUM">Média</option>
                                <option value="HIGH">Alta</option>
                                ...
                                {task.subtasks.map(sub => (
                                  <div key={sub.id} className="flex items-center gap-2 group">
                                    <input
                                      ...
                                      className="w-3.5 h-3.5 rounded border-gray-300 text-primary cursor-pointer shrink-0"
                                    />
