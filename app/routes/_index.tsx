...
export default function Index() {
  ...
  useEffect(() => {
    ...
    // Simple CSS-based animation fallback since gsap was removed
    const elements = heroRef.current.querySelectorAll('.gsap-hero-badge, .gsap-hero-title, .gsap-hero-subtitle, .gsap-hero-cta');
