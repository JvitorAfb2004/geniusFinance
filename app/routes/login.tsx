      ...
      <div className="bg-surface p-8 rounded-2xl shadow-none border border-border text-center max-w-md w-full relative z-10">
        ...
        <div className="mt-4 pt-4 border-t border-border">
          <button
            ...
            className="w-full bg-text-primary hover:bg-[#0f172a] text-surface font-medium py-3 px-4 rounded-xl transition-all flex items-center justify-center gap-3 shadow-sm hover:shadow-md cursor-pointer"
          >
      ...
      {isGoogleTermsModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white border border-gray-100 p-6 rounded-2xl shadow-xl max-w-sm w-full z-10 text-center animate-scale-up">
            ...
            {/* Checkbox do Google */}
            <label className="flex items-start gap-2.5 cursor-pointer p-3 bg-gray-50 border border-gray-100 rounded-xl mb-6 text-left hover:bg-gray-100/70 transition-colors">
              <input
                type="checkbox"
              ...
              />
              <span className="text-xs leading-relaxed select-none text-gray-600">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-medium py-2.5 px-4 rounded-xl text-sm transition-all cursor-pointer"
              >
                Cancelar
              </button>
              <button
                ...
                className="flex-1 bg-primary hover:bg-blue-700 disabled:bg-primary/50 text-white font-bold py-2.5 px-4 rounded-xl text-sm transition-all shadow-sm disabled:shadow-none disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
              >
                Continuar
              </button>
            </div>
