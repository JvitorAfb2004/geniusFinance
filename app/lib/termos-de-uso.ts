...
Para utilizar a plataforma, o usuário deverá criar uma conta por meio de autenticação Google e fornecer informações verdadeiras, completas e atualizadas.

O usuário é responsável por:
- Manter seus dados atualizados;
- Proteger suas credenciais de acesso (conta Google vinculada);
- Não compartilhar sua conta com terceiros não autorizados;
- Informar imediatamente qualquer uso indevido ou acesso não autorizado;
- Garantir que os usuários convidados para sua conta empresarial respeitem estes Termos.

A GENIUS WEB poderá suspender ou encerrar contas em caso de fraude, uso indevido, violação destes Termos ou risco à segurança da plataforma.

3. USO PERMITIDO DA PLATAFORMA

O usuário poderá utilizar a plataforma para fins lícitos relacionados à gestão financeira, gestão de projetos, organização interna, acompanhamento de tarefas, controle de receitas e despesas, emissão de relatórios e demais funcionalidades disponíveis.

É proibido utilizar a plataforma para:
- Praticar atos ilícitos;
- Inserir dados falsos, fraudulentos ou de origem ilegal;
- Violar direitos de terceiros;
- Tentar acessar contas, dados ou áreas restritas sem autorização;
- Realizar engenharia reversa, cópia indevida ou exploração do sistema;
- Enviar malware, scripts maliciosos ou conteúdo prejudicial;
- Sobrecarregar a infraestrutura;
- Utilizar a plataforma para lavagem de dinheiro, fraude financeira ou qualquer atividade ilegal;
- Comercializar, revender ou sublicenciar o acesso sem autorização.

4. RESPONSABILIDADE PELOS DADOS INSERIDOS

O usuário é integralmente responsável pelas informações que inserir na plataforma, incluindo dados financeiros, dados de clientes, fornecedores, colaboradores, projetos, tarefas, documentos, anexos e relatórios.

A GENIUS WEB não se responsabiliza pela veracidade, legalidade, precisão ou atualização dos dados inseridos pelo usuário.

A plataforma é uma ferramenta de gestão e organização. Ela não substitui contador, advogado, consultor financeiro, auditor ou qualquer profissional especializado.

5. GESTÃO FINANCEIRA

As funcionalidades financeiras da plataforma têm finalidade organizacional e gerencial.

O usuário reconhece que:
- Os relatórios dependem dos dados inseridos pelo próprio usuário;
- A plataforma não garante resultado financeiro;
- A plataforma não presta consultoria contábil, fiscal, jurídica ou financeira;
- O usuário é responsável por validar informações antes de tomar decisões;
- Obrigações fiscais, contábeis e legais continuam sendo responsabilidade do usuário.

6. GESTÃO DE PROJETOS

As funcionalidades de projetos têm finalidade de organização, acompanhamento e controle operacional, incluindo quadro Kanban, tarefas com subtarefas, prioridades, responsáveis e prazos.
...
A GENIUS WEB poderá, no futuro, oferecer planos pagos com funcionalidades adicionais. Caso isso ocorra, os usuários serão comunicados previamente e a migração para planos pagos será opcional.
...
Após o encerramento:
- Os dados poderão ser excluídos, anonimizados ou mantidos pelo prazo necessário ao cumprimento de obrigações legais;
- O usuário deverá exportar seus dados antes do encerramento definitivo, utilizando a funcionalidade de exportação disponível na plataforma (exportação CSV de transações na tela de Configurações).
...
A plataforma poderá ficar temporariamente indisponível por:
...
O usuário deve manter cópias próprias das informações relevantes, especialmente dados financeiros, projetos e relatórios estratégicos.
...
O usuário recebe apenas uma licença limitada, não exclusiva, intransferível e revogável para utilizar a plataforma conforme estes Termos.
...
A GENIUS WEB poderá implementar medidas de segurança como autenticação, logs, bloqueios preventivos e verificação de acesso.
...
- Decisões tomadas com base em dados inseridos pelo usuário;
- Erros decorrentes de informações incorretas cadastradas pelo usuário;
...
A versão atualizada será publicada em geniusweb.online, com indicação da data de atualização.
