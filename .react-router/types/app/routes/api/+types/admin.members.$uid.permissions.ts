...
type Module = typeof import("../admin.members.$uid.permissions.js")

type Info = GetInfo<{
  file: "routes/api/admin.members.$uid.permissions.ts",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../admin.members.$uid.permissions.js");
}];
